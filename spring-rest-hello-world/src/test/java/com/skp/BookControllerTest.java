...
public class BookControllerTest {
    ...
    @Before
    public void init() {
        Book book = new Book(1L, "Book Name", "Sumant", new BigDecimal("9.99"));
    ...
    public void find_bookId_OK() throws Exception {
        ...
        mockMvc.perform(get("/books/1"))
                ...
                .andExpect(jsonPath("$.author", is("Sumant")))
    ...
    public void save_book_OK() throws Exception {
        ...
        Book newBook = new Book(1L, "Spring Boot Guide", "skp", new BigDecimal("2.99"));
        ...
        mockMvc.perform(post("/books")
                ...
                .andExpect(jsonPath("$.author", is("skp")))
    ...
    public void update_book_OK() throws Exception {
        ...
        Book updateBook = new Book(1L, "ABC", "skp", new BigDecimal("19.99"));
